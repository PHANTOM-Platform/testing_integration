# Example of Uploaded Statistics to the Execution Manager

The data file in this folder, which is in JSON format, is the uploaded statistics into the Execution Manager from a previous execution of the example.
